...
static plugins::TypedEnumPlugin<UnsolvabilityVerificationType> _enum_plugin({
        {"none", "no unsolvability verification"},
        {"certificate", "inductive certificates unsolvability verification"},
        {"certificate_fastdump", "inductive certificates unsolvability verification dumping BDDs separately (improves memory usage but larger bdd file)"},
        {"certificate_nohints", "inductive certificates unsolvability verification without creating a hint file (faster generation, slower verification)"},
        {"proof", "proof system unsolvability verification"},
        {"proof_discard", "proof system unsolvability verification discarding formulas when they are not needed anymore (improves memory usage but larger bdd file)"}
    });
